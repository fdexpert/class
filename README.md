...
寫給零 R 基礎修課學生的課前準備教材，規劃四篇十九章約 8 小時，目前為 **v0.2，僅含導論與第一篇**（四件工具的分工、RStudio 介面與必改設定、Project 工作流、套件管理），其餘章節在側欄顯示為待撰寫。深淺主題、章節路由、鍵盤翻頁、程式碼複製、Windows 操作差異逐章註記；四章各嵌一支已驗證的英文示範影片，點縮圖會跳到對應時間點。
